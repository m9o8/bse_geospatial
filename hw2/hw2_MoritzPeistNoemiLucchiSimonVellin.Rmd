...
In order to plot the distribution of the total population by country, we only need the R packages world, which contains both the geometries of the countries and the corresponding population. 

## Data Wrangling 

Given that we plot the population both in absolute terms and by categories — low, medium, and high — we need to define the population ranges for these categories. We classify countries with a population up to the 30th percentile as "Low population" countries, those with a population between the 30th and 70th percentiles as "Medium population" countries, and those in the top 30% of the population distribution as "High population" countries.

```{r}

# Divide the population by categories
world <- world %>%
