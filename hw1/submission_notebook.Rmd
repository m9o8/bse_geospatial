...
Additionally, we explored the R package censobr, which is expected to contain Brazil's census data for earlier years. Unfortunately, despite using the function data_dictionary and experimenting with various arguments (e.g., "population," "households," etc.), we were unable to retrieve population data. Instead, the package provided other types of data that were not relevant to our analysis.
...
Again, as outlined above, we only replicate the 2010 map, due to data non-availability in the prior periods.
